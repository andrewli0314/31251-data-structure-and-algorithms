...
class directed_graph {
 ...
 public:
  ...
  typedef
      typename std::unordered_set<vertex>::const_iterator const_vertex_iterator;
  typedef typename std::unordered_set<vertex>::const_iterator
  ...
  const_vertex_iterator begin() const { return vertices.cbegin(); }

  const_vertex_iterator end() const { return vertices.cend(); }

  neighbour_iterator nbegin(const vertex& u) { return edges.at(u).begin(); }

  neighbour_iterator nend(const vertex& u) { return edges.at(u).end(); }
